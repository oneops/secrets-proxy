...
public class Invitations extends TableImpl<InvitationsRecord> {
  ...
  public final TableField<InvitationsRecord, Integer> ID =
      createField(
          "id",
  ...
  public final TableField<InvitationsRecord, String> EMAIL =
      createField("email", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

  /** The column <code>public.invitations.token</code>. */
  public final TableField<InvitationsRecord, String> TOKEN =
      createField("token", org.jooq.impl.SQLDataType.VARCHAR.length(8), this, "");

  /** The column <code>public.invitations.comment</code>. */
  public final TableField<InvitationsRecord, String> COMMENT =
      createField("comment", org.jooq.impl.SQLDataType.VARCHAR.length(200), this, "");

  /** The column <code>public.invitations.created_at</code>. */
  public final TableField<InvitationsRecord, Timestamp> CREATED_AT =
  ...
  public final TableField<InvitationsRecord, Timestamp> UPDATED_AT =
