...
public class SchemaMigrations extends TableImpl<SchemaMigrationsRecord> {
  ...
  public final TableField<SchemaMigrationsRecord, String> VERSION =
      createField(
          "version", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");
  ...
  private SchemaMigrations(
      String alias, Table<SchemaMigrationsRecord> aliased, Field<?>[] parameters) {
