...
public class UserWatches extends TableImpl<UserWatchesRecord> {
  ...
  public final TableField<UserWatchesRecord, Integer> ID =
      createField(
          "id",
