...
public class CiProxiesTeams extends TableImpl<CiProxiesTeamsRecord> {
  ...
  public final TableField<CiProxiesTeamsRecord, Integer> ID =
      createField(
          "id",
