...
public class MiscDocs extends TableImpl<MiscDocsRecord> {
  ...
  public final TableField<MiscDocsRecord, Integer> ID =
      createField(
          "id",
          org.jooq.impl.SQLDataType.INTEGER
              ...
              .defaultValue(
                  org.jooq.impl.DSL.field(
                      "nextval('misc_docs_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)),
          this,
          "");

  /** The column <code>public.misc_docs.name</code>. */
  public final TableField<MiscDocsRecord, String> NAME =
      createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(50), this, "");

  /** The column <code>public.misc_docs.document</code>. */
  public final TableField<MiscDocsRecord, String> DOCUMENT =
      createField("document", org.jooq.impl.SQLDataType.CLOB, this, "");

  /** The column <code>public.misc_docs.created_at</code>. */
  public final TableField<MiscDocsRecord, Timestamp> CREATED_AT =
  ...
  public final TableField<MiscDocsRecord, Timestamp> UPDATED_AT =
