 ...
 * specified name, the client will send a header with each request with a specified name and value
 * of the server-supplied cookie.
 *
 * @author Suresh
 * @see <a
 *     href="https://en.wikipedia.org/wiki/Cross-site_request_forgery#Cookie-to-Header_Token">Cookie-to-Header
 *     Token, an anti-CSRF technique.</a>
 */
