 ...
 *
 * <p>Note: renamed from CreateClientRequest because swagger docs do not handle class name
 * collisions.
 */
@AutoValue
public abstract class CreateClientRequestV2 {
  ...
  public static Builder builder() {
    return new AutoValue_CreateClientRequestV2.Builder().groups().description("");
  }
