...
public abstract class SetSecretVersionRequestV2 {
  SetSecretVersionRequestV2() {} // prevent sub-classing

  public static Builder builder() {
    return new AutoValue_SetSecretVersionRequestV2.Builder().name("").version(0);
  }
  ...
  public static SetSecretVersionRequestV2 fromParts(
    ...
    return builder().name(name).version(version).build();
  }
