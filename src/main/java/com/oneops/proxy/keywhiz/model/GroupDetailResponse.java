...
public class GroupDetailResponse {
  ...
  @JsonProperty private final ApiDate creationDate;

  @JsonProperty private final ApiDate updateDate;

  @JsonProperty private final String createdBy;

  @JsonProperty private final String updatedBy;

  @JsonProperty private final ImmutableMap<String, String> metadata;

  @JsonProperty private final ImmutableList<SanitizedSecret> secrets;

  @JsonProperty private final ImmutableList<Client> clients;
  ...
  public static GroupDetailResponse fromGroup(
      Group group, ImmutableList<SanitizedSecret> secrets, ImmutableList<Client> clients) {
