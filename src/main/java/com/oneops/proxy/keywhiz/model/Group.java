...
public class Group {
  ...
  @JsonProperty private final ApiDate createdAt;

  @JsonProperty private final String createdBy;

  @JsonProperty private final ApiDate updatedAt;
  ...
  public int hashCode() {
    return Objects.hashCode(
        id, name, description, createdAt, createdBy, updatedAt, updatedBy, metadata);
  }
