...
public class ClientDetailResponse {
  ...
  @JsonProperty public final ApiDate creationDate;

  @JsonProperty public final ApiDate updateDate;

  @JsonProperty public final String createdBy;

  @JsonProperty public final String updatedBy;

  @JsonProperty public final ApiDate lastSeen;

  /** List of secrets the group has access to. The secrets do not contain content. */
  @JsonProperty public final ImmutableList<SanitizedSecret> secrets;
  ...
  public static ClientDetailResponse fromClient(
      Client client, ImmutableList<Group> groups, ImmutableList<SanitizedSecret> secrets) {
