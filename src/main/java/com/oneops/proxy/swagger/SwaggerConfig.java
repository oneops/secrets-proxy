...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("OneOps Secrets API " + Constants.API_VERSION)
                .description("OneOps Secrets proxy api documentation.")
                .contact(new Contact("OneOps", "https://oneops.github.com/secrets-proxy", ""))
