...
public class LdapUserService {
  ...
  /**
   * Returns the common name from LDAP entry. Usually, AD common name has <b>"FullName - UserId"</b>
   * format. If that's the case, only full name is returned as the common name.
   *
