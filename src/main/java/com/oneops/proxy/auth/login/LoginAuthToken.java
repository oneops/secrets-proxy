...
public class LoginAuthToken extends AbstractAuthenticationToken {
     ...
     * <code>LoginAuthToken</code>, as the {@link #isAuthenticated()} will return
     * <code>false</code>.
     */
     ...
     * @param authorities
     */
    public LoginAuthToken(Object principal, Object credentials, Collection<? extends GrantedAuthority> authorities) {
        super(authorities);
        this.principal = principal;
        this.credentials = credentials;
