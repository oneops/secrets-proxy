...
public class ErrorControllerAdvice {
  ...
  /**
   * An exception handler method for {@link IllegalArgumentException} thrown from all the Rest
   * controllers.
   *
  ...
  /**
   * An exception handler method for {@link KeywhizException} thrown from all the Rest controllers.
   *
   * @param req Http request.
  ...
  public ResponseEntity<?> handleIOException(
      HttpServletRequest req, HttpServletResponse res, KeywhizException ex) {
    String path = getReqPath(req);
