...
public class AuthController {
  ...
  /**
   * The token mapping is provided only for generating swagger documentation and shouldn't be called
   * in any case. The actual token authentication is done using the {@link
   * com.oneops.proxy.auth.token.TokenAuthProcessingFilter}.
   *
  ...
  @ApiOperation(
    ...
    notes = "Use this Bearer token for all other requests."
  )
