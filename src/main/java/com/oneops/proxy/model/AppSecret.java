...
public class AppSecret {
     ...
     *
     * @param uniqSecretName globally unique secret name.
     *                       It has the format <b>{domain}_{AppGroupName}@{secretName}</b>
     */
    ...
    /**
     * Returns the secret name used by the user. The secret name is usually
     * used as the secret file name in applications.
     *
     * @return secret name.
     */
    ...
    /**
     * Keywhiz is designed to have globally unique names. This method returns a
     * globally unique secret name based on your application group.
     * <p>
     * The unique secret name format is := <b>{domain}_{AppGroupName}@{secretName}</b>
     * <p>
     * Eg: If user uploads a secret with name <b>db-password.txt</b> for an env <b>prod</b>,
     * assembly <b>my-app</b> and org <b>oneops</b>, the app id is <b>oneops_my-app_prod</b>
     * and the secret name stored in keywhiz server will be <b>prod_oneops_my-app_prod@db-password.txt</b>.
     * The initial <b>prod_</b> is the default domain. The domain is mainly used to support
     * multiple OneOps instances.
     *
     * @return String globally unique secret name.
     */
    public String getUniqSecretName() {
        return String.format("%s%s%s%s%s", group.getDomain(), GROUP_SEP, group.getName(), UNIQ_NAME_SEP, secretName);
    }
