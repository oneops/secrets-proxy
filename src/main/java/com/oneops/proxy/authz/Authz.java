...
public class Authz {
    ...
    /**
     * Checks if the given team is a 'secret-admin' and has access to manage
     * design and transition for the given application group.
     *
    ...
    public boolean hasAdminAccess(OneOpsTeam team, AppGroup appGroup) {
        return team.isSecretsAdmin(appGroup.getAssembly())
                && team.isDesign()
                && team.isTransition();
    }
}
