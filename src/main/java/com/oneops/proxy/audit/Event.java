 ...
 *
 * <p>Eg: <b>SECRET_CREATE | User: suresh | Group: oneops_keywhiz-proxy_prod | Object:
 * prod_db_password.txt | ExtraInfo:</b>
 *
 * @author Suresh
 */
public class Event {
  ...
  public String toString() {
    ...
    return String.format(
        "%-25s | User: %-15s | Group: %-45s | Object: %-30s | ExtraInfo: %s ",
        type, user, appGroup, objectName, extInfo);
  }
}
